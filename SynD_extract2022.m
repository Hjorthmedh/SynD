...
classdef SynD_extract2022 < handle
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  function H = crossEntropy(obj, thresh, edges, freqG)
	  ...
	  H = sum(freq0.*(mu0.*log(mu0./val0) + val0.*log(val0./mu0)), 'omitnan') ...
          + sum(freq1.*(mu1.*log(mu1./val1) + val1.*log(val1./mu1)), 'omitnan');
  ...
  function exportToXML(obj)
    ...
    columnData = { nSynapses, ...
		   ...
		   mean(obj.data.synapseIntensitySynMean(okMidx) ...
			./obj.data.synapseIntensityMorphMean(okMidx), 'omitnan'), ...
		   mean(obj.data.synapseIntensityXMean(okMidx) ...
			./obj.data.synapseIntensityMorphMean(okMidx), 'omitnan'), ...
		   mean(obj.data.synapseIntensityXMean(okSidx) ...
			./obj.data.synapseIntensitySynMean(okSidx), 'omitnan') };
